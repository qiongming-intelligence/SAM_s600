...
def export_entrypoint(partition_name: str) -> str:
    modules = {
        ...
        "geometry_encoder": "detector",
        "detector": "detector",
        "mask_decoder": "mask_decoder",
        "memory_encoder": "video_tracker",
        "tracker": "video_tracker",
        "multiplex_detector": "multiplex",
        "multiplex_tracker": "multiplex",
    }
    module = modules.get(partition_name, partition_name)
    return f"python -m sam_s600_tools.export.{module}"
